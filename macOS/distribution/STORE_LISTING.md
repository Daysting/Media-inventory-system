...
**Keywords:** inventory,books,games,movies,electronics,library,borrowers,loans,collections
...
Use the dashboard and reports to review your inventory and lending activity. Print reports for your records and export a portable inventory backup whenever you need one.

Optional iCloud sync keeps your inventory available on Macs using the same Apple ID. Cover images travel with your inventory. If two Macs make conflicting changes, choose which inventory to keep; copies are saved for recovery.

Your inventory is stored on your Mac. No separate app account or web server is required.
